...
constexpr bool Approx(T x, T y, f32 eps = kEpsilonF) noexcept { return Abs(x - y) < eps; }

template<cFloatType T>
constexpr bool NotApprox(T x, T y, f32 eps = kEpsilonF) noexcept { return not Approx(x, y, eps); }
