...
template <cUnsignedType T>
constexpr int CountClearedBits(T value)
{
    return BitSize<T>() - Popcount(value);
}
...
template <cUnsignedType T>
constexpr T PreviousPowerOfTwo(T value)
{
...
template <cUnsignedType T>
constexpr T RotateLeft(T value, int count)
{
    return std::rotl(value, count);
}

template <cUnsignedType T>
constexpr T RotateRight(T value, int count)
{
    return std::rotr(value, count);
}

template <cUnsignedType T>
constexpr T SetBit(T value, int pos)
{
    return value | (static_cast<T>(1) << pos);
}

template <cUnsignedType T>
constexpr T ClearBit(T value, int pos)
{
    return value & ~(static_cast<T>(1) << pos);
}

template <cUnsignedType T>
constexpr T ToggleBit(T value, int pos)
{
    return value ^ (static_cast<T>(1) << pos);
}

template <cUnsignedType T>
constexpr bool CheckBit(T value, int pos)
{
    return (value >> pos) & 1;
}
...
template <cUnsignedType T>
constexpr T UintMinus(T value) noexcept
{
    return (value == std::numeric_limits<T>::min()) ? std::numeric_limits<T>::max() : value - 1;
}

constexpr u64 MergeUint32ToUint64(u32 high, u32 low) noexcept
{
