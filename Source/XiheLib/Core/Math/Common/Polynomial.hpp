...
XIHE_ALWAYS_INLINE T EvaluatePolynomial(T, C c) { return As<T>(c); }

template<typename T, typename C, typename... Args>
XIHE_ALWAYS_INLINE T EvaluatePolynomial(T t, C c, Args... cRemaining) { return FMA(t, As<T>(EvaluatePolynomial(t, cRemaining...)), As<T>(c)); }
