...
public:
    ...
    constexpr explicit SplitMix32Engine(u64 seedVal = 0x9E3779B97f4A7C15ULL) noexcept
    {
        seed(seedVal);
    }

    constexpr void seed(u64 seedVal) noexcept
    {
        _state = As<u32>(SplitMix64(seedVal));
    }
...
public:
    ...
    constexpr explicit SplitMix64Engine(u64 seedVal = 0xDEADBEEFCAFED00DULL) noexcept
    {
        seed(seedVal);
    }
